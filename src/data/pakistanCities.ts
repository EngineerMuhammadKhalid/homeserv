export const PAKISTAN_CITIES: Record<string, string[]> = {
  England: [
    'London','Birmingham','Manchester','Leeds','Bristol','Liverpool','Newcastle','Sheffield','Coventry','Leicester','Nottingham','Plymouth','Sunderland','Southampton','Derby','Stoke-on-Trent','Wolverhampton','Lincoln','Oxford','Cambridge','York','Winchester','Bath','Exeter','Chester','Worcester','Hereford','Peterborough','Gloucester'
  ],
  Scotland: [
