...
import { collection, query, where, onSnapshot, orderBy, updateDoc, doc, addDoc, increment, getDoc, getDocs, limit } from 'firebase/firestore';
...
export const Bookings = () => {
  ...
  useEffect(() => {
    ...
    const unsubscribeBookings = onSnapshot(qBookings, (snapshot) => {
      const bookingData = snapshot.docs.map(doc => ({ id: doc.id, ...(doc.data() as any) }));
