              ...
              <>
                ...
                >
                  ...
                  {profile?.role === 'provider' && (
                    <MenuItem component={Link} to="/professional-profile" onClick={handleCloseUserMenu}>
                      <ListItemIcon><Briefcase fontSize="small" /></ListItemIcon>
                      <Typography variant="body2" fontWeight={600}>Professional Profile</Typography>
                    </MenuItem>
                  )}
                  <Divider />
